...
class MLPModel:
    def __init__(self):
        self.r2_mlp_percentage = None
        self.results = None
    
    def train_mlp(self, file_path, features: list, target: str):
        ...
        r2_mlp = r2_score(y, y_pred_all)
        self.r2_mlp_percentage = r2_mlp * 100
        ...
        # print(f"R^2 score for the MLP model: {r2_mlp_percentage:.2f}%")
